...
def saveGesture(data_dictionary, name):
    ...
    with open(f'{package_path}/database/Gestures/{name}.pkl', 'wb') as savefile:
...
def train_model():
    ...
    with open(f'{package_path}/database/trained_models/trained_model.pkl', 'wb') as savefile:                        #These two lines is build to export the best model "here it's rf" and save it in a files called trained_model.pkl
