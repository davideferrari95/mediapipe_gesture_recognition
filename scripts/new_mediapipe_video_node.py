...
from mediapipe_gesture_recognition.srv import VideoSequence
  ...
  def stream(self):
    ...
    for root, dirs, files in sorted(os.walk(self.path)):
        ...
        for filename in files:
                ...
                video_number = os.path.splitext(filename)[0]
                ...
                while self.cap.isOpened() and not rospy.is_shutdown():
                    ...
                    #Save Data
                    self.recordVideos(gesture_name,video_number,sequence)
